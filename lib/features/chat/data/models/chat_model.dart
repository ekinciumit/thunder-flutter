...
/// Chat Type Enum (Data Layer - Firestore mapping için)
/// 
/// Bu enum ChatEntity'deki ChatType ile aynı, ama data layer'da kullanılıyor
enum ChatType {
  private,
  group,
  channel,
...
/// Chat Model (DTO - Data Transfer Object)
/// 
/// Clean Architecture Data Layer
/// Firestore'a özel tipler içerir (Timestamp, GeoPoint vb.)
/// Domain layer'a bağımlı değil
class ChatModel {
  final String id;
  final String name;
...
/// Chat Participant Model (DTO)
/// 
/// Clean Architecture Data Layer
/// Firestore'a özel tipler içerir
